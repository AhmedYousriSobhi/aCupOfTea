...
- [3.2.2-Process-The-init-Process](#322-process-the-init-process)
  - [Note - The init process](#note---the-init-process)
  - [Modern Init Systems](#modern-init-systems)
- [3.2.2-Process-Parent-child-relationship](#322-process-parent-child-relationship)
  ...
  - [Resource](#resource)
- [3.3.1-Process-fork-\&-exec](#331-process-fork--exec)
...
# 3.2.2-Process-The-init-Process
...
# 3.2.2-Process-Parent-child-relationship
