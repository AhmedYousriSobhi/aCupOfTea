...
- [Create a New Environment](#create-a-new-environment)
  - [Check Envrionment List](#check-envrionment-list)
  - [Exit an Environment](#exit-an-environment)
  - [Question](#question)
  - [Remove an Environment](#remove-an-environment)
- [Conda Channels](#conda-channels)
  - [Specifying Channels When Installing Packages](#specifying-channels-when-installing-packages)
    - [Where conda command search for .condarc?](#where-conda-command-search-for-condarc)
    - [Want to Configure Channels and Their Priority for a Single Env?](#want-to-configure-channels-and-their-priority-for-a-single-env)
  - [Managing Channels](#managing-channels)
- [Managing Packages](#managing-packages)
  - [Searching for Pacakges](#searching-for-pacakges)
  - [Installing Packages](#installing-packages)
    - [1- Install Packages on Created Environment](#1--install-packages-on-created-environment)
    - [2- Install Packages While Creating Environment](#2--install-packages-while-creating-environment)
- [Reference](#reference)
...
A free one you ask?! Sure, the **conda-forge** channel is free for all to use.
...
## Conda .condarc file!
What is ***.condarc***? it is the file where are conda channels are configured, refer to ["*Using the .condarc conda configuration file*"](https://conda.io/projects/conda/en/latest/user-guide/configuration/use-condarc.html) docs.
...
- To edit the configuration file, there is two methods;
  ...
  - 2- vim the file and write it manually using YAML syntax. Here is a [sample of .condarc file](https://conda.io/projects/conda/en/latest/user-guide/configuration/use-condarc.html#sample-condarc) from the documents, which you could simply download and edit it.
    ...
    ```
### Where conda command search for .condarc?
...
### Want to Configure Channels and Their Priority for a Single Env?
...
### 1- Install Packages on Created Environment
...
You can define the target specified package version, and also install multiple packages together.
```bash
# install scipy package version 0.15.0, and curl package
conda install scipy=0.15.0 curl
```
...
### 2- Install Packages While Creating Environment
